class TranslationsController < ApplicationController
  ...
  def create
    ...
    redirect_to translations_url, :notice => t('translations.notice.translation_added')
  end
  ...
  def destroy
    ...
    respond_with(@translation) do |format|
      format.html { redirect_to new_translation_path(:type => params[:type], :language => params[:language]) }
      format.js
    end
  end
  ...
  def dump
    ...
    redirect_to translations_path, :notice => t('translations.notice.dumped')
  end
